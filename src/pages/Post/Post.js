    ...
    <div className="w-full max-w-md m-auto mt-6 pb-20">
      <div className="bg-zinc-800 max-w-md rounded overflow-hidden shadow-lg">
        ...
        <div className="px-6 pt-4 pb-2">
          ...
          <span 
            className="inline-block bg-emerald-400 rounded-full px-3 py-1 text-sm font-semibold text-white mr-2 mb-2 cursor-pointer"
            onClick={ () => navigate(`/editar-publicacion/${post._id}`) }
            >
