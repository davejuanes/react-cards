...
export const FormPost = () => {
  ...
  return (
    <div className="w-full max-w-lg m-auto mt-6 pb-12">
      ...
      >
        {({ handleSubmit, setFieldValue, isSubmitting }) => (
          <Form
            className="bg-zinc-800 shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col"
          ...
          >
            ...
            <div className="mb-4">
              ...
              <input
                ...
                accept="image/*"
                onChange={(e) => {
                  setFieldValue("archivo", e.target.files[0]);
                }}
              />
              <ErrorMessage
                component="p"
            ...
            <div className="flex items-center justify-between">
              ...
              >
                { isSubmitting ? (<AiOutlineLoading3Quarters className="animate-spin h5 w-5"/>) : ('Guardar') }
              </button>
            </div>
          </Form>
        )}
